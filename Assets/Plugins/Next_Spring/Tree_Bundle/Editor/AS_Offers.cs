...
public class Startup
{
    static Startup()
    {
        EditorPrefs.SetInt("showCounts_mobileTreePack_12", EditorPrefs.GetInt("showCounts_mobileTreePack_12") + 1);
        if (EditorPrefs.GetInt("showCounts_mobileTreePack_12") == 100)    
        { 
        ...
        // Rate me
        EditorPrefs.SetInt("showCounts_rate_mobileTreePack_12", EditorPrefs.GetInt("showCounts_rate_mobileTreePack_12") + 1);
        if (EditorPrefs.GetInt("showCounts_rate_mobileTreePack_12") == 30)                 
        {   
